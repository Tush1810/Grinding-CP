...
public class q2 implements Runnable {
    ...
    public void solve() {
        ...
        for (int i = 0; i < n; i++) {
            if ((arr[i] % 2) == 0) {
                evens.addLast(arr[i]);
            } else odds.addLast(arr[i]);
        }
        // System.out.println(evens.size());
        // System.out.println(odds.size());
        for (int i = 0; i < n; i++) {
            // System.out.println("1)" + temp[i]);
            // System.out.println("2)" + evens.pollFirst());
            // System.out.println("3)" + odds.pollFirst());
            if ((temp[i] % 2) == 0) {
                if (evens.size() > 0 && evens.peekFirst() == temp[i]) {
                    evens.pollFirst();
                } else {
                    pw.println("NO");
                    return;
                ...
                if (odds.size() > 0 && odds.peekFirst() == temp[i]) {
                    odds.pollFirst();
                } else {
                    pw.println("NO");
                    return;
