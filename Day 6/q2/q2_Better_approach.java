...
public class q2_Better_approach implements Runnable {

    public static void main(String[] args) {
        new Thread(null, new q2_Better_approach(), "whatever", 1 << 26).start();
    }
    ...
    public void solve() {
        ...
        for (int i = 1; i < n; i++) {
            if (arr[i] == '?') {
                ...
                dp[i][arr[i] - '0'] = dp[i - 1][(arr[i] - '0' + 1) % 2] + 1;
                dp[i][(arr[i] - '0' + 1) % 2] = 0;
            }
