...
public class q1 implements Runnable {
    ...
    public void solve() {
        ...
        for (int i = 0; i < 26; i++) {
            if (set.contains(String.valueOf(((char)(i + 'a')))))
                dq.addLast(String.valueOf(((char)(i + 'a'))));
            else {
                pw.println(String.valueOf(((char)(i + 'a'))));
                return;
            }
        }
        while (true) {
            String str = dq.poll();
            for (int i = 0; i < 26; i++) {
                if (set.contains(String.valueOf(str + ((char)(i + 'a')))))
                    dq.addLast(String.valueOf(str + ((char)(i + 'a'))));
                else {
                    pw.println(String.valueOf(str + ((char)(i + 'a'))));
                    return;
                }
            }
        }
